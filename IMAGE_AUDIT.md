...
> owner-selected `ChatGPT Image Aug 10, 2026, 05_51_20 AM.png`. Open Graph,
> Twitter, and structured metadata use its no-crop baseline-JPEG derivative,
> `social-share-v2.jpg`, to remain below the conservative 300 KiB messenger
> budget. Both retain the real 1672×941 dimensions.
...
| `public/images/ChatGPT Image Aug 10, 2026, 05_51_20 AM.png` | 2.38 MB | Untouched owner-selected social-card source |
| `public/images/social-share-v2.jpg` | 280 KB | No-crop baseline-JPEG derivative used by `app/layout.tsx` Open Graph/Twitter/structured metadata |
