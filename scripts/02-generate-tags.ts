/**
 * 02-generate-tags.ts — Generate Tags Script
 *
 * Batch-processes verses to generate classification tags and metadata.
 * Run once to enrich the verse database with searchable tags and categories.
