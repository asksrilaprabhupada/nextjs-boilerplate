/**
 * 01-generate-embeddings.ts — Generate Embeddings Script
 *
 * Batch-processes all verses to generate vector embeddings and store them in Supabase.
 * Run once to populate the semantic search index for the entire verse database.
 *
