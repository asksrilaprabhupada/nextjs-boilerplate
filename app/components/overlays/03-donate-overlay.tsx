/**
 * 03-donate-overlay.tsx — Donate Overlay
 *
 * Shows bank details with copy-to-clipboard buttons for donations.
 * Allows supporters to easily copy payment details for contributing to the project.
 */
"use client";
