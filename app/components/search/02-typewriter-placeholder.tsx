/**
 * 02-typewriter-placeholder.tsx — Typewriter Placeholder
 *
 * Animates rotating example questions inside the search input as placeholder text.
 * Inspires users by showing the kinds of spiritual questions they can ask.
 */
"use client";
