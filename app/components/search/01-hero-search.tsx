  ...
  return (
    <section style={{
      ...
      <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", width: "100%", maxWidth: 700 }}>
        ...
        {/* Tagline */}
        {heroVisible && <p className="font-body tagline-gradient" style={{ ...stagger(1), fontSize: "clamp(15px, 1.6vw, 17px)", fontWeight: 500, textAlign: "center", letterSpacing: "0.03em", marginBottom: 22 }}>Nothing Added, Nothing Invented.</p>}
