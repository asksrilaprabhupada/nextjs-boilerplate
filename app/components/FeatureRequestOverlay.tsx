...
export default function FeatureRequestOverlay() {
  ...
  if (sent) {
    return (
      <div style={{ textAlign: "center", padding: "40px 0" }}>
        ...
        <p className="font-body" style={{ fontSize: 15, color: "#9CA3AF" }}>We appreciate your ideas. Hare Kṛṣṇa!</p>
  ...
  return (
    <div>
      ...
      <p className="font-body" style={{ fontSize: 14, color: "#9CA3AF", marginBottom: 20 }}>
        Help us make Ask Śrīla Prabhupāda even better. What would you love to see?
      </p>
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        <div>
          <label className="font-body" style={{ fontSize: 12, fontWeight: 500, color: "#9CA3AF", marginBottom: 6, display: "block", textTransform: "uppercase", letterSpacing: "0.1em" }}>Your Name</label>
        ...
        <div>
          <label className="font-body" style={{ fontSize: 12, fontWeight: 500, color: "#9CA3AF", marginBottom: 6, display: "block", textTransform: "uppercase", letterSpacing: "0.1em" }}>Email (optional)</label>
          <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="your@email.com" style={inputStyle}
            onFocus={e => { e.currentTarget.style.borderColor = "#8B5CF6"; }} onBlur={e => { e.currentTarget.style.borderColor = "rgba(196,181,253,0.3)"; }} />
        </div>
        <div>
          <label className="font-body" style={{ fontSize: 12, fontWeight: 500, color: "#9CA3AF", marginBottom: 6, display: "block", textTransform: "uppercase", letterSpacing: "0.1em" }}>Feature Description</label>
