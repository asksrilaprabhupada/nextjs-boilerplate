...
export default function AboutOverlay() {
  return (
    <div>
      ...
      <div className="font-body" style={{ fontSize: 16, lineHeight: 1.7, fontWeight: 400, color: "#4B5563", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <p>Every answer is traced directly to specific verses and passages from Prabhupāda&apos;s books — Bhagavad Gītā, Śrīmad Bhāgavatam, Caitanya Caritāmṛta, Nectar of Devotion, Kṛṣṇa Book, Teachings of Lord Caitanya, and 21 more books.</p>
        ...
        <p>Our database contains <strong style={{ color: "#8B5CF6" }}>25,112 verses</strong> and <strong style={{ color: "#7C3AED" }}>34,145 prose paragraphs</strong> across <strong style={{ color: "#6366F1" }}>27 books</strong>, each with original Sanskrit/Bengali, transliteration, word-for-word synonyms, translation, and the complete purport by Śrīla Prabhupāda. Every reference links directly to <a href="https://vedabase.io" target="_blank" rel="noopener noreferrer" style={{ color: "#8B5CF6", textDecoration: "none", fontWeight: 500 }}>Vedabase.io</a>.</p>
        <p style={{ fontSize: 14, color: "#9CA3AF", borderTop: "1px solid rgba(196,181,253,0.2)", paddingTop: 16, marginTop: 8 }}>
