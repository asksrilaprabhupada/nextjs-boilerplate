/**
 * 02-left-rail.tsx — Left Rail Sidebar
 *
 * Displays keywords, synonyms, and related concepts extracted from the search query.
 * Helps users understand the key topics found across Srila Prabhupada's teachings.
 */
"use client";
