/**
 * 03-right-rail.tsx — Right Rail Sidebar
 *
 * Shows citation counts per book and "Want More" buttons to expand results from each scripture.
 * Lets users dive deeper into specific books from Srila Prabhupada's library.
 */
"use client";

import type { Citation, BookGroup } from "./01-narrative-response";
