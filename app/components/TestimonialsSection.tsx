      ...
      <div className="testimonials-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
        {testimonials.map((t) => (
          <div key={t.name} className="aurora-card scroll-reveal" style={{ display: "flex", flexDirection: "column", gap: 20, padding: "28px 24px" }}>
            ...
            <p className="font-body" style={{ fontSize: 15, fontWeight: 400, fontStyle: "italic", lineHeight: 1.7, color: "#4B5563", flex: 1, marginTop: -12 }}>
              {t.quote}
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: 12, borderTop: "1px solid rgba(196,181,253,0.15)", paddingTop: 16 }}>
              ...
              <div>
                ...
                <div className="font-body" style={{ fontSize: 12, fontWeight: 400, color: "#9CA3AF" }}>{t.role}</div>
              </div>
            </div>
          </div>
        ))}
