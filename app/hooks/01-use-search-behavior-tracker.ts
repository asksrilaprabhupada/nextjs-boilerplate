/**
 * 01-use-search-behavior-tracker.ts — Search Behavior Tracker Hook
 *
 * Tracks time spent viewing results, scroll depth, and citation clicks for analytics.
 * Provides behavioral signals that help measure and improve search quality.
 */
"use client";

import { useEffect, useRef, useCallback } from "react";
import { logBehavior } from "../lib/02-analytics";
