/**
 * 06-lockscreen-data.ts — Lock Screen Data
 *
 * Defines the slideshow images, fallback image, optional video path, and daily verse rotation data.
 * Configures what content appears on the lock screen intro experience.
 */
