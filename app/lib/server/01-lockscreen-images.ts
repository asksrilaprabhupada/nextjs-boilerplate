/**
 * 01-lockscreen-images.ts — Server-Side Lock Screen Images
 *
 * Reads lockscreen images from the filesystem and provides them to the API.
 * Handles image discovery, HEIC detection, and Ken Burns direction assignment on the server.
 */
import { promises as fs } from "node:fs";
import path from "node:path";
import { KEN_BURNS_DIRECTIONS, lockscreenFallbackImage, type SlideImage } from "../06-lockscreen-data";
