...
const UPDATES: Update[] = [
  ...
  },
  {
    ...
    details: ["Created passages table and helper functions.", "Added robust JSON ingest with GitHub Actions."],
  },
  {
    date: "2025-08-28",
    title: "Project bootstrap",
    details: ["Next.js app scaffolded and deployed on Vercel.", "Initial design and navigation created."],
  },
];
